...
export const HOME_CATEGORIES = [
  {
    ...
    fields: [
      ...
      { name: 'disponibilite', label: 'Dates', type: 'select', options: [
        { value: 'permanent', label: 'Aucune' },
        { value: 'a_venir', label: 'À venir' },
        { value: 'duree_limitee', label: 'Période limitée' },
      ], default: 'permanent' },
      { name: 'periode_debut', label: 'À partir du', type: 'text', placeholder: 'Ex. 1er déc. 2026', schedulePart: 'debut' },
      { name: 'periode_fin', label: 'Au', type: 'text', placeholder: 'Ex. 28 fév. 2027', schedulePart: 'fin' },
      PLACE_PRICE_FIELD,
      PLACE_TRAVEL_FIELD,
    ],
  },
